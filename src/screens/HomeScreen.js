  ...
  return (
    ...
    <StatusBar style="dark"/>
     ...
     className="space-y-6 pt-14">
         ...
         <Image source={require("../../assets/ava.webp")} style={{height:hp(5), width:hp(5.5)}} className="rounded-full"/>
             <BellIcon size={hp(4)} color="gray"/>
         </View>

         <View className="mx-4 space-y-2 mb-2">
         <Text style={{fontSize:hp(1.7)}} className="text-neutral-600">Hello, Sam</Text>
         <View >
         ...
         <View className="bg-white rounded-full p-3">
          ...
          <View>
           {categories.length > 0 &&  <Categories categories={categories} handleChangeCategory={handleChangeCategory} activeCategory={activeCategory}/>}
          </View>
